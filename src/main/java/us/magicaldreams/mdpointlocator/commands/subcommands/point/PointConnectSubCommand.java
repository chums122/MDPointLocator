...
public class PointConnectSubCommand implements MDSubCommand
{
    ...
    public void onCommand(CommandSender sender, Command command, String[] args) {
        ...
        else
        {
            ...
            player.sendMessage(CommonUtil.getBrandedMsgPrefix(ChatColor.YELLOW + "Line created between the points successfully"));
        }
    ...
    public String getDescription() {
        return "Create a line between two points.";
    }
}
